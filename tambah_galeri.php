...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif (count($_FILES['foto']['name']) > 10) {
        $error = "Maksimal 10 foto yang diperbolehkan.";
    } else {
        // Simpan data galeri
...
<div class="container py-5">
    <div class="card shadow-sm p-4 mx-auto" style="max-width:600px;">
        ...
        <form method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
                <label for="foto" class="form-label">Upload Foto (maks. 10 foto, format jpg/jpeg/png/gif/webp)</label>
